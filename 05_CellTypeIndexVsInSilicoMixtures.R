...
pdf("AstrocyteMixtureRatiosVsIndex_NoDarmanis.pdf", height=5, width=4)
plot(apply(AstrocyteMixtures[c(1, 3:5),], 2, mean)~AstrocyteMixtureRatios, pch=18, ylab="Astrocyte Index", xlab="Mixture (% Astrocyte)")
BestFitLine<-lm(apply(AstrocyteMixtures[c(1, 3:5),], 2, mean)~AstrocyteMixtureRatios)
...
pdf("OligodendrocyteMixtureRatiosVsIndex_NoDarmanis.pdf", height=5, width=4)
plot(apply(OligodendrocyteMixtures[c(29:31, 33:34),], 2, mean)~OligodendrocyteMixtureRatios, pch=18, ylab="Oligodendrocyte Index", xlab="Mixture (% Oligodendrocyte)")
BestFitLine<-lm(apply(OligodendrocyteMixtures[c(29:31, 33:34),], 2, mean)~OligodendrocyteMixtureRatios)
abline(BestFitLine, lwd=2)
abline(a=(BestFitLine$coefficients[1]+summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
abline(a=(BestFitLine$coefficients[1]-summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
...
pdf("MicrogliaMixtureRatiosVsIndex_NoDarmanis.pdf", height=5, width=4)
plot(apply(MicrogliaMixtures[c(11:12),], 2, mean)~MicrogliaMixtureRatios, pch=18, ylab="Microglia Index", xlab="Mixture (% Microglia)")
BestFitLine<-lm(apply(MicrogliaMixtures[c(11:12),], 2, mean)~MicrogliaMixtureRatios)
abline(BestFitLine, lwd=2)
abline(a=(BestFitLine$coefficients[1]+summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
abline(a=(BestFitLine$coefficients[1]-summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
...
pdf("EndothelialMixtureRatiosVsIndex_NoDarmanis.pdf", height=5, width=4)
plot(apply(EndothelialMixtures[c(6,8:9),], 2, mean)~EndothelialMixtureRatios, pch=18, ylab="Endothelial Index", xlab="Mixture (% Endothelial)")
BestFitLine<-lm(apply(EndothelialMixtures[c(6,8:9),], 2, mean)~EndothelialMixtureRatios)
abline(BestFitLine, lwd=2)
abline(a=(BestFitLine$coefficients[1]+summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
abline(a=(BestFitLine$coefficients[1]-summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
...
pdf("NeuronMixtureRatiosVsIndex_NoDarmanis.pdf",  height=5, width=4)
plot(apply(NeuronMixtures[c(16,18),], 2, mean)~NeuronMixtureRatios, pch=18, ylab="Neuron Index", xlab="Mixture (% Neuron)")
BestFitLine<-lm(apply(NeuronMixtures[c(16,18),], 2, mean)~NeuronMixtureRatios)
abline(BestFitLine, lwd=2)
abline(a=(BestFitLine$coefficients[1]+summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
abline(a=(BestFitLine$coefficients[1]-summary.lm(BestFitLine)[[6]]), b=BestFitLine$coefficients[2], col="grey", lwd=2)
